(function ($) {
    const css = window.ASSET_URL + "assets/css/";
    ...
    <div class="customizer-header">
        <div class="theme-title">
            ...
            <div class="flex-grow-1">
                <a id="grip-close" class="icon-btn btn-outline-light button-effect pull-right grip-close">
    ...
    <div class="customizer-body custom-scrollbar">
        ...
        <ul class="layout-grid sidebar-type layout-types">
            <li data-attr="compact-sidebar">
                <div class="layout-img">
                    <a href="javascript:void(0)">
                        <img alt="" class="img-fluid" src="${imgBase}landing/layout-images/dubai.jpg">
                    </a>
                    <h6>Dubai</h6>
                </div>
            </li>
            <li data-attr="material-layout">
                <div class="layout-img">
                    <a href="javascript:void(0)">
                        <img alt="" class="img-fluid" src="${imgBase}landing/layout-images/los-angle.png">
                    </a>
                    <h6>Los Angeles</h6>
                </div>
            </li>
            <li data-attr="dark-sidebar">
                <div class="layout-img">
                    <a href="javascript:void(0)">
                        <img alt="" class="img-fluid" src="${imgBase}landing/layout-images/paris.jpg">
                    </a>
                    <h6>Paris</h6>
                </div>
            </li>
            <li data-attr="compact-wrap">
                <div class="layout-img">
                    <a href="javascript:void(0)">
                        <img alt="" class="img-fluid" src="${imgBase}landing/layout-images/tokyo.jpg">
                    </a>
                    <h6>Tokyo</h6>
                </div>
            </li>
            <li data-attr="compact-small">
                <div class="layout-img">
                    <a href="javascript:void(0)">
                        <img alt="" class="img-fluid" src="${imgBase}landing/layout-images/moscow.jpg">
                    </a>
                    <h6>Moscow</h6>
                </div>
            </li>
            <li data-attr="enterprice-type">
                <div class="layout-img">
                    <a href="javascript:void(0)">
                        <img alt="" class="img-fluid" src="${imgBase}landing/layout-images/singapore.jpg">
                    </a>
                    <h6>Singapore</h6>
                </div>
            </li>
            <li class="box-layout" data-attr="box-layout">
                <div class="layout-img">
                    <a href="javascript:void(0)">
                        <img alt="" class="img-fluid" src="${imgBase}landing/layout-images/newyork.png">
                    </a>
                    <h6>New York</h6>
                </div>
            </li>
            ...
            <li data-attr="material-icon">
                <div class="layout-img">
                    <a href="javascript:void(0)">
                        <img alt="" class="img-fluid" src="${imgBase}landing/layout-images/rome.jpg">
                    </a>
                    <h6>Rome</h6>
                </div>
            </li>
            ...
            <li class="only-body" data-attr="default-body">
                <div class="layout-img">
                    <a href="javascript:void(0)">
                        <img alt="" class="img-fluid" src="${imgBase}landing/layout-images/landon.png">
                    </a>
                    <h6>London</h6>
                </div>
            </li>
...
<section class="setting-sidebar">
    <div class="customizer-header">
        <div class="theme-title">
            ...
            <div class="flex-grow-1">
                <a id="cog-close" class="icon-btn btn-outline-light button-effect pull-right cog-close">
                    <i class="fa-solid fa-xmark fa-fw"></i>
                </a>
            </div>
        </div>
    ...
    <div class="customizer-body custom-scrollbar">
        ...
        <ul class="layout-grid main-layout">
            <li class="active" data-attr="ltr">
                <div class="bg-light header"><ul><li></li><li></li><li></li></ul></div>
        ...
        <ul class="layout-grid sidebar-type">
            <li data-attr="normal-sidebar">
                <div class="bg-light header"><ul><li></li><li></li><li></li></ul></div>
                <div class="body"><ul><li class="sidebar bg-dark"></li><li class="bg-light body"></li></ul></div>
            </li>
            <li data-attr="compact-sidebar">
                <div class="bg-light header"><ul><li></li><li></li><li></li></ul></div>
                <div class="body"><ul><li class="sidebar bg-dark compact"></li><li class="bg-light body"></li></ul></div>
            </li>
        </ul>
        <h6>Unlimited Color</h6>
        <ul class="layout-grid unlimited-color-layout"><input id=ColorPicker1 name=Background type=color
                value=#7366ff><input id=ColorPicker2 name=Background type=color value=#838383><button
                class="color-apply-btn color-apply-btn btn btn-primary" type=button>Apply</button></ul>
        <h6>Light layout</h6>
        ...
        <ul class="layout-grid sidebar-setting">
            <li class=active data-attr=stroke-svg>
                ...
                <div class="bg-light body"><span class="badge badge-primary">Stroke</span></div>
            <li data-attr=fill-svg>
                ...
                <div class="bg-light body"><span class="badge badge-primary">Fill</span></div>
        </ul>
        <h6>Mix Layout</h6>
        <ul class="layout-grid customizer-mix">
            <li class="color-layout active" data-attr=light-only>
                ...
                <div class="body common-layout"><span class="badge badge-secondary">Light</span>
                    <ul>
            ...
            <li class=color-layout data-attr=dark-sidebar>
                ...
                <div class="body common-layout"><span class="badge badge-secondary">Sidebar</span>
                    <ul>
            ...
            <li class=color-layout data-attr=dark-only>
                ...
                <div class="body common-layout"><span class="badge badge-secondary">Dark</span>
                    <ul>
                        <li class="sidebar bg-dark">
                        <li class="body bg-dark">
                    </ul>
                </div>
            <li class=color-layout id=auto-layout onclick="detectColorScheme()">
                <div class="bg-light header">
                    <ul>
                        <li>
                        <li>
                ...
                <div class="body common-layout"><span class="badge badge-secondary">Auto</span>
                    <ul>
                        <li class="sidebar bg-dark">
                        <li class="bg-light body">
                    </ul>
        ...
        <ul class="layout-link">
            <li><a href="https://support.pixelstrap.com/"><i class="icon-headphone-alt"></i><span>Support</span></a>
            </li>
            <li><a href="https://docs.pixelstrap.com/cuba/html/document/"><i
                        class="icon-file"></i><span>Document</span></a></li>
            <li><a href="https://admin.pixelstrap.com/cuba/template/landing-page.html#"><i
                        class="icon-panel"></i><span>Features</span></a></li>
            <li><a href="https://1.envato.market/3GVzd"><i class="icon-shopping-cart-full"></i><span>Buy
                        Now</span></a></li>
        </ul>
    </div>
</section>
