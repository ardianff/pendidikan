                     ...
                     <li class="sidebar-list">
                         <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link " href="#"><svg
                                 class="stroke-icon">
                     ...
                     <li class="sidebar-list">
                         <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link " href="#"><svg
                                 ...
                                 <use href="{{ url('assets/svg/icon-sprite.svg') }}#fill-table"></use>
                             </svg><span>Kota/Kabupaten</span></a>
