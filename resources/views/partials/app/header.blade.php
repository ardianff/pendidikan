    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper">
                <a href="{{ url('/') }}">
                    <img class="img-fluid for-light" src="{{ url('assets/images/logo/logo.png') }}" alt="Logo" />
                    <img class="img-fluid for-dark" src="{{ url('assets/images/logo/logo_dark.png') }}" alt="Logo Dark" />
                </a>
            </div>
        ...
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div class="notification-slider">
                <div class="d-flex h-100">
                    <img src="{{ url('assets/images/giftools.gif') }}" alt="Notification GIF" />
            ...
            <ul class="nav-menus">
                    ...
                    <div class="translate_wrapper">
                        ...
                        <div class="more_lang">
                            ...
                            <div class="lang" data-value="pt">
                                ...
                                <span class="lang-txt">Português (BR)</span>
                            </div>
                            ...
                            <div class="lang" data-value="ae">
                                ...
                                <span class="lang-txt">لعربية (AE)</span>
                            </div>
                        </div>
                    </div>
                </li> --}}
                            ...
                            <div class="flip-card-inner">
                                ...
                                <div class="back">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="f-w-700 d-block flip-back btn btn-primary w-100" id="flip-back"
                                                href="#!">Back</a>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="cart-dropdown onhover-show-div">
                        ...
                        <ul>
                            <li>
                                <div class="d-flex">
                                    <img class="img-fluid b-r-5 me-3 img-60"
                                        src="{{ url('assets/images/other-images/cart-img.jpg') }}" alt="Cart Item" />
                            ...
                            <li>
                                <div class="d-flex">
                                    <img class="img-fluid b-r-5 me-3 img-60"
                                        src="{{ url('assets/images/other-images/cart-img1.jpg') }}" alt="Cart Item" />
                                    <div class="flex-grow-1">
                            ...
                            <li class="text-center">
                                <a class="d-block view-cart f-w-700 btn btn-primary w-100" href="cart.html">View
                                    Cart</a>
                                <a class="btn btn-primary view-checkout f-w-700 w-100"
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    <div class="d-flex profile-media">
                        <img class="b-r-10" src="{{ url('assets/images/dashboard/profile.png') }}" alt="Profile" />
                        <div class="flex-grow-1">
                            <span>{{ Auth::user()->name }}</span>
                            <p class="mb-0">{{ Auth::user()->roles->first()->name }} <i
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li><a href="{{ route('password.request') }}"><i data-feather="settings"></i><span>Reset
                                    Password</span></a></li>
