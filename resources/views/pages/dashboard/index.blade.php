             ...
             <div class="row widget-grid">
                             ...
                             <div class="card widget-1">
                                 <div class="card-body">
                                     <div class="widget-content">
                                         ...
                                         <div>
                                             <h4>$<span class="counter" data-target="45195">0</span></h4>
                             ...
                             <div class="card widget-1">
                                 <div class="card-body">
                                     <div class="widget-content">
                                         ...
                                         <div>
                                             <h4><span class="counter" data-target="80">0</span>%</h4>
                     ...
                     <div class="card monthly-header">
                                 ...
                                 <div class="card-header-right-icon">
                                     <div class="dropdown icon-dropdown">
                                         <button class="btn dropdown-toggle" id="monthlyButton" type="button"
                                             data-bs-toggle="dropdown" aria-expanded="false"><i
                                                 class="icon-more-alt"></i></button>
                                         <div class="dropdown-menu dropdown-menu-end" aria-labelledby="monthlyButton">
                                             <a class="dropdown-item" href="#!">Today</a><a class="dropdown-item"
                                                 href="#!">Tomorrow</a><a class="dropdown-item"
                                                 href="#!">Yesterday</a>
                                         </div>
                         ...
                         <div class="card-body">
                             ...
                             <div class="target-content">
                                 <p>Revenue Surges! Today's earnings soar to $3653, marking an impressive uptick from last
                                     month. Keep the momentum going!</p>
                                 <div class="common-box">
                                     <ul class="common-flex">
                                         <li>
                                             <h6>Revenue</h6>
                                             <span class="common-space badge badge-light-success"> <i class="me-1"
                                                     data-feather="trending-up"></i>$20k</span>
                                         </li>
                                         <li>
                                             <h6>Target</h6>
                                             <span class="common-space badge badge-light-danger"><i class="me-1"
                             ...
                             <ul>
                                     ...
                                     <div class="w-100 ms-3">
                                         <div class="d-flex justify-content-between align-items-center">
                                             <p class="mb-0 f-16 f-w-500">
                                                 Brooklyn Simmons<span class="f-w-400">(Commented:<a
                                                         href="#!">&nbsp;NFT App</a>)</span>
                                             </p>
                                 ...
                                 <li class="d-flex">
                                     ...
                                     <div class="w-100 ms-3">
                                         <div class="d-flex justify-content-between align-items-center">
                                             <p class="mb-0 f-16 f-w-500">
                                                 Leslie Alexander<span class="f-w-400">(Shared images:<a
                                                         href="#!">&nbsp; Barkha</a>)</span>
                                             </p>
                                         ...
                                         <ul class="common-flex pb-1">
                                             <li><img class="img-fluid" src="../assets/images/dashboard/bg-1.png"
                                                     alt="background" /></li>
                                             <li><img class="img-fluid" src="../assets/images/dashboard/bg-2.png"
                                                     alt="background" /></li>
                                             <li><img class="img-fluid" src="../assets/images/dashboard/bg-3.png"
                                                     alt="background" /></li>
                                         </ul>
                                 ...
                                 <li class="d-flex">
                                     ...
                                     <div class="w-100 ms-3">
                                         <div class="d-flex justify-content-between align-items-center">
                                             <p class="mb-0 f-16 f-w-500">
                                                 Kristin Watson <span class="f-w-400">(Add new screen: <a
                                                         href="#!">&nbsp;Cuba Admin</a>)</span>
                                             </p>
                                             <span class="c-light">7:00 AM </span>
                                         </div>
                                 ...
                                 <table class="table" id="main-recent-order">
                                     ...
                                     <tbody>
                                         ...
                                         <tr>
                                             ...
                                             <td>14 Apr,2024</td>
                                             <td><button
                                                     class="btn button-light-danger txt-danger f-w-500">Canceled</button>
                                             </td>
                                         </tr>
                                         <tr>
                                             <td></td>
                 ...
                 <div class="col-xxl-3 col-lg-4 col-sm-6 box-col-4 ord-xl-7 ord-md-2 box-ord-7">
                     <div class="card buy-card">
                         <img class="img-fluid" src="../assets/images/dashboard/purchase1.png"
                             alt="vector mens with laptop" />
                         <div class="card-body">
                             <h6 class="mb-3">Buy <a class="txt-info" href="#!">Pro Account </a>to Explore Premium
                                 Features</h6>
                     ...
                     <div class="card sales-report">
                                 ...
                                 <div class="card-header-right-icon">
                                     <div class="dropdown icon-dropdown">
                                         <button class="btn dropdown-toggle" id="salesButton" type="button"
                                             data-bs-toggle="dropdown" aria-expanded="false"><i
                                                 class="icon-more-alt"></i></button>
                                         <div class="dropdown-menu dropdown-menu-end" aria-labelledby="salesButton">
                                             <a class="dropdown-item" href="#!">Today</a><a class="dropdown-item"
                                                 href="#!">Tomorrow</a><a class="dropdown-item"
                                                 href="#!">Yesterday</a>
                                         </div>
                         ...
                         <div class="card-body pt-0">
                             <ul class="balance-data">
                                 ...
                                 <li><span class="circle bg-warning"> </span><span class="c-light ms-1">Earnings</span>
                                 </li>
                                 <li><span class="circle bg-secondary"> </span><span class="c-light ms-1">Refunds</span>
                                 </li>
                             </ul>
                                 ...
                                 <div class="card-header-right-icon">
                                     <div class="dropdown icon-dropdown">
                                         <button class="btn dropdown-toggle" id="manageButton" type="button"
                                             data-bs-toggle="dropdown" aria-expanded="false"><i
                                                 class="icon-more-alt"></i></button>
                                         <div class="dropdown-menu dropdown-menu-end" aria-labelledby="manageButton">
                                             <a class="dropdown-item" href="#!">Today</a><a class="dropdown-item"
                                                 href="#!">Tomorrow</a><a class="dropdown-item"
                                                 href="#!">Yesterday</a>
                                         </div>
                         ...
                         <div class="card-body pt-0">
                             <ul class="appointments-wrapper">
                                 <li class="d-flex align-items-start">
                                     ...
                                     <div class="main-box">
                                         <div class="mb-2"><span>Participating Meeting</span><span
                                                 class="c-o-light">There are many variations of passages
                                                 available</span><span class="txt-primary">2:00 PM - 4:30 PM</span></div>
