     ...
     <div class="work-process-container-wrapper style1">
         <div class="container">
             <div class="section-title text-center mxw-565 mx-auto">
                 <div class="subtitle wow fadeInUp" data-wow-delay=".2s">How It Work <img
                         src="{{ asset('front/assets/images/icon/fireIcon.svg') }}" alt="icon" /></div>
             ...
             <div class="work-process-wrapper style1">
                 <div class="shape"><img src="{{ asset('front/assets/images/shape/workProcessShape1_1.png') }}"
                         alt="shape" /></div>
                 <div class="row">
                     <div class="col-xl-4">
