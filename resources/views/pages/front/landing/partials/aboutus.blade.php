                    ...
                    <div class="col-xl-6">
                        <div class="about-thumb">
                            ...
                            <div class="thumbShape1 d-none d-xxl-block cir36">
                                <img src="{{ asset('front/assets/images/shape/aboutThumbShape1_1.png') }}"
                                    alt="shape" />
                            </div>
                            <div class="thumbShape2 d-none d-xxl-block cir36">
                                <img src="{{ asset('front/assets/images/shape/aboutThumbShape1_2.png') }}"
                                    alt="shape" />
                            </div>
                            <div class="thumbShape3 d-none d-xxl-block cir36 float-bob-y">
                                <img src="{{ asset('front/assets/images/shape/aboutThumbShape1_3.png') }}"
                                    alt="shape" />
                            </div>
                            <div class="thumbShape4 d-none d-xxl-block cir36">
                                <img src="{{ asset('front/assets/images/shape/aboutThumbShape1_4.png') }}"
                                    alt="shape" />
                            </div>
                            <div class="main-thumb">
                                <img src="{{ asset('front/assets/images/about/aboutThumb1_1.png') }}" alt="thumb" />
                            </div>
                            <div class="absolute-thumb float-bob-x">
                                <img src="{{ asset('front/assets/images/about/aboutThumb1_2.png') }}" alt="thumb" />
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="about-content">
                            ...
                            <ul class="checklist style1 wow fadeInUp" data-wow-delay=".2s">
                                <li>
                                    <img src="{{ asset('front/assets/images/icon/checkmarkIcon.svg') }}"
                                        alt="icon" />
